...
Partial Public Class BABancosEdicionDataSet
    ...
    Private relationFK_BATransaccionesEncabezado_BABancos As Global.System.Data.DataRelation
    ...
    Friend Overloads Sub InitVars(ByVal initTable As Boolean)
        ...
        If (initTable = true) Then
            ...
            End If
        End If
        Me.relationFK_BATransaccionesEncabezado_BABancos = Me.Relations("FK_BATransaccionesEncabezado_BABancos")
    End Sub
    ...
    Private Sub InitClass()
        ...
        Me.relationFK_BATransaccionesEncabezado_BABancos = New Global.System.Data.DataRelation("FK_BATransaccionesEncabezado_BABancos", New Global.System.Data.DataColumn() {Me.tableBABancos.CodigoBancoColumn}, New Global.System.Data.DataColumn() {Me.tableBATransaccionesEncabezado.CodigoBancoColumn}, false)
        Me.Relations.Add(Me.relationFK_BATransaccionesEncabezado_BABancos)
    End Sub
    ...
    Partial Public Class BATransaccionesEncabezadoDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddBATransaccionesEncabezadoRow(ByVal parentBABancosRowByFK_BATransaccionesEncabezado_BABancos As BABancosRow, ByVal TipoDocumento As Short, ByVal NoDocumento As Integer, ByVal Fecha As Date, ByVal FactorCambio As Decimal, ByVal Beneficiario As String, ByVal Monto As Decimal, ByVal Concepto As String, ByVal Anulado As Boolean, ByVal Cerrado As Boolean, ByVal DescripcionTipo As String) As BATransaccionesEncabezadoRow
            Dim rowBATransaccionesEncabezadoRow As BATransaccionesEncabezadoRow = CType(Me.NewRow,BATransaccionesEncabezadoRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nothing, TipoDocumento, NoDocumento, Fecha, FactorCambio, Beneficiario, Monto, Concepto, Anulado, Cerrado, DescripcionTipo}
            If (Not (parentBABancosRowByFK_BATransaccionesEncabezado_BABancos) Is Nothing) Then
                columnValuesArray(1) = parentBABancosRowByFK_BATransaccionesEncabezado_BABancos(0)
            End If
    ...
    Partial Public Class BABancosRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function GetBATransaccionesEncabezadoRows() As BATransaccionesEncabezadoRow()
            If (Me.Table.ChildRelations("FK_BATransaccionesEncabezado_BABancos") Is Nothing) Then
                Return New BATransaccionesEncabezadoRow(-1) {}
            Else
                Return CType(MyBase.GetChildRows(Me.Table.ChildRelations("FK_BATransaccionesEncabezado_BABancos")),BATransaccionesEncabezadoRow())
            End If
        End Function
    End Class
    ...
    Partial Public Class BATransaccionesEncabezadoRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Property BABancosRow() As BABancosRow
            Get
                Return CType(Me.GetParentRow(Me.Table.ParentRelations("FK_BATransaccionesEncabezado_BABancos")),BABancosRow)
            End Get
            Set
                Me.SetParentRow(value, Me.Table.ParentRelations("FK_BATransaccionesEncabezado_BABancos"))
            End Set
        End Property
    ...
    Partial Public Class BATransaccionesDetalleTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Id, CodigoBanco, TipoDocumento, NoDocumento, Fecha, Cuenta, Debe, H"& _ 
                ...
                "talle"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (CodigoBanco = @CodigoBanco) AND (Año = @Año) AND (Mes = @Me"& _ 
                "s)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY TipoDocumento, NoDocumento"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CodigoBanco", Global.System.Data.SqlDbType.SmallInt, 2, Global.System.Data.ParameterDirection.Input, 0, 0, "CodigoBanco", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
